 ...
 * the same speaker, 0 if it doesn't or doesn't exist. (So not a pairwise {@link SimilarityMeasure} at all really - one
 * argument will be null)
 * 
 * @author mpurver
 */
public class SentenceLastConstructionSameSimilarityMeasure implements SimilarityMeasure<DialogueSentence> {
	 ...
	 */
	public SentenceLastConstructionSameSimilarityMeasure(String bnfPattern1, String bnfPattern2) {
		super();
