 ...
 * current index, leftWindow contains all other sentences from the speaker at the current index
 * 
 * @author mpurver
 */
public class SameSpeakerAllOtherSentenceWindower extends SentenceWindower {

	private HashMap<DialogueSpeaker, ArrayList<DialogueSentence>> speakerSents;

	public SameSpeakerAllOtherSentenceWindower(Dialogue dialogue, int left, int right, int step) {
