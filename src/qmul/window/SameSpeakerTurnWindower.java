...
/**
 * A {@link DialogueWindower} based on {@link DialogueTurn} speaker turns - both leftWindow and rightWindow contain only
 * turns from the speaker at the current index
 * 
 * @author mpurver
 */
public class SameSpeakerTurnWindower extends TurnWindower {

	public SameSpeakerTurnWindower(Dialogue dialogue, int left, int right, int step) {
