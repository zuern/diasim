...
/**
 * A {@link DialogueWindower} based on {@link DialogueSentence} sentences - rightWindow contains only sentences from the
 * speaker at the current index, leftWindow contains only sentences from other speakers
 * 
 * @author mpurver
 */
public class OtherSpeakerSentenceWindower extends SentenceWindower {

	public OtherSpeakerSentenceWindower(Dialogue dialogue, int left, int right, int step) {
