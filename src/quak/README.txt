...
2.
    ...
    Run quak.TestingTools.createCorpus, and specify the File where you want your corpus to be saved.

    It should be saved as "SomeCorpusName.corpus"
3.
    If you're interested in syntactic similarity, use the quak.TestingTools.parseCorpus method to parse the syntax
